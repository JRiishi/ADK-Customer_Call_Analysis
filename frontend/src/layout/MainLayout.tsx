...
import { LayoutDashboard, PhoneCall, BarChart2, ShieldAlert, LogOut } from 'lucide-react';
...
const MainLayout = () => {
    ...
    const navItems = [
        { icon: PhoneCall, label: 'Agent Console', path: '/' },
        { icon: LayoutDashboard, label: 'Supervisor Dashboard', path: '/dashboard' },
        { icon: BarChart2, label: 'Analytics & Coaching', path: '/analytics' },
        { icon: ShieldAlert, label: 'System Health', path: '/system' },
    ];
